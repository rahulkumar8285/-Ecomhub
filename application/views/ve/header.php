...
<head>
    ...
    <title>Vendor Dh</title>
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="<?php echo base_url('public/vendorasset');?>/vendor/bootstrap/css/bootstrap.min.css">
    <link href="<?php echo base_url('public/vendorasset');?>/vendor/fonts/circular-std/style.css" rel="stylesheet">
                    ...
                    <ul class="navbar-nav ml-auto navbar-right-top">
                        ...
                        <li class="nav-item dropdown nav-user">
                            ...
                            <div class="dropdown-menu dropdown-menu-right nav-user-dropdown"
                                ...
                                <a class="dropdown-item" href="<?php echo base_url('vendor-logout') ; ?>"><i class="fas fa-power-off mr-2"></i>Logout</a>
                            </div>
                        </li>
                    </ul>
                </div>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false"
                                    data-target="#submenu-2" aria-controls="submenu-2"><i
                                        class="fa fa-fw fa-rocket"></i>Prodect</a>
                                <div id="submenu-2" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="<?php echo base_url('/ve/add-prodect');?>">Add Prodect <span
                                                    class="badge badge-secondary">New</span></a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="<?php echo base_url('/ve/ProdectList');?>">Add Variation</a>
                                        </li>
